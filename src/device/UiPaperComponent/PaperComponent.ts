...
export abstract class PaperComponent<T> extends Component<PaperWidgetProps & T> {
    ...
    protected onPropertiesChange() {
        this.colorNormal = this.props.paperBackgroundNormal ?? this.root.theme.PAPER_NORMAL;
        this.colorSelected = this.props.paperBackgroundSelected ?? this.root.theme.PAPER_SELECTED;
        this.colorPressed = this.props.paperBackgroundPressed ?? this.root.theme.PAPER_PRESSED;
    }
